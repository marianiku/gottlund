...
<head>
  ...
  ?>
  <title><?php echo __("Metsäsuomalaisten kirjeet Gottlundille"); ?></title>
...
<header role="banner">
  ...
  <div id="site-title" style="width:98%;height:10%;">
    <?php echo link_to_home_page($text = __("Metsäsuomalaisten kirjeet Gottlundille")); ?>
    ...
    <a href="http://www.finlit.fi" target="_blank">
      ...
      src="<?php echo 'http://10.214.32.27/gottlund/sks_header_logo.png'; ?>" />
    </a>
  </div>
  <!-- main header links-->
